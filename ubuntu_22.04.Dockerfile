...
# Configure systemd as the init system. Replaces the former jrei/systemd-ubuntu
# base (published for linux/amd64 only) by mirroring its setup on top of the
# official, multi-arch ubuntu image.
